...
{
    unsafe class UnityEngine_AsyncOperation_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            method = type.GetMethod("set_allowSceneActivation", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, set_allowSceneActivation_1);
        ...
        static StackObject* set_allowSceneActivation_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
